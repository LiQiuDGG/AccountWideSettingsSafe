local L = LibStub("AceLocale-3.0"):NewLocale("AccWideUISafeAddonLocale", "enUS", true, true)
...
L["ACCWUI_ISSUES"] = "Issues? Please visit https://github.com/jfogarty/AccountWideSettingsSafe/issues"
